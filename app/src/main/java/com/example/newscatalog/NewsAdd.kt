    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        saveNews.setOnClickListener {
            ...
            if (newsTitle.isEmpty() || newsDesc.isEmpty()) {
                Toast.makeText(
                    this@NewsAdd, "titlle and Description cannot be empty",
                    Toast.LENGTH_SHORT
                ).show()
...
// Add your logic here
            if (newsTitle.isEmpty() || newsDesc.isEmpty()) {
                Toast.makeText(
                    this@NewsAdd, "Title and Description cannot be empty",
                    Toast.LENGTH_SHORT
                ).show()
                return@setOnClickListener
            }
        ...
        if (id != null) {
            dbNews.collection("news").document(id ?: "")
                ...
                .addOnSuccessListener {
                    progressDialog.dismiss()
                    Toast.makeText(
                        this@NewsAdd, "News added successfully",
                        Toast.LENGTH_SHORT
                    ).show()
                    finish()
                }
                .addOnFailureListener { e ->
                    progressDialog.dismiss()
                    Toast.makeText(
                        this@NewsAdd, "Error adding news: ${e.message}",
                        Toast.LENGTH_SHORT
                    ).show()
